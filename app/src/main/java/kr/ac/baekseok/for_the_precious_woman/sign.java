...
//                AlertDialog.Builder dlgSignup = new AlertDialog.Builder(sign.this);
//                dlgSignup.setMessage("회원가입이 완료되었습니다.");
//                dlgSignup.setPositiveButton("OK", new DialogInterface.OnClickListener() {
//                    @Override
